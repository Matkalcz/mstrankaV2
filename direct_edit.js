...
const initData = JSON.stringify({
  ...
  params: {
    ...
    capabilities: {},
    clientInfo: { name: 'direct-edit', version: '1.0.0' }
  }
});
    ...
    const editData = JSON.stringify({
      ...
      params: {
        ...
        arguments: {
          ...
          htmlContent: '<div class="container py-8"><h2 class="text-3xl font-bold mb-4">ROUNDHEAT Technology</h2><p>Test content for ROUNDHEAT section</p></div>',
          sortOrder: 6,
